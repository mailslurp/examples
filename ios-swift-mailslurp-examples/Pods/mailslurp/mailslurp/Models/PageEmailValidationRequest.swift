...
@objc public class PageEmailValidationRequest: NSObject, Codable, JSONEncodable {
    ...
    public init(content: [EmailValidationRequestDto]? = nil, pageable: PageableObject? = nil, totalPages: Int, totalElements: Int64, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {

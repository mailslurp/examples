//
// PageInboxForwarderEvents.swift
//
...
@objc public class PageInboxForwarderEvents: NSObject, Codable, JSONEncodable {

    public var content: [InboxForwarderEventProjection]?
    ...
    public init(content: [InboxForwarderEventProjection]? = nil, pageable: PageableObject? = nil, totalPages: Int, totalElements: Int64, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {

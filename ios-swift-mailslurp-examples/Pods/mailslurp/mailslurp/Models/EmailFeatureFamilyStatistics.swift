//
// EmailFeatureFamilyStatistics.swift
//
...
@objc public class EmailFeatureFamilyStatistics: NSObject, Codable, JSONEncodable {
    ...
    public var platforms: [EmailFeaturePlatformStatistics]

    public init(feature: Feature, family: Family, platforms: [EmailFeaturePlatformStatistics]) {

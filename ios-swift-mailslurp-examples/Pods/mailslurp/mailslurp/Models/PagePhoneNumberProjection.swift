//
// PagePhoneNumberProjection.swift
//
...
@objc public class PagePhoneNumberProjection: NSObject, Codable, JSONEncodable {

    public var content: [PhoneNumberProjection]?
    ...
    public init(content: [PhoneNumberProjection]? = nil, pageable: PageableObject? = nil, totalPages: Int, totalElements: Int64, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {

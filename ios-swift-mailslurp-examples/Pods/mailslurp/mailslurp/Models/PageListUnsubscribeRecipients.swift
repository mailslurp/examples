//
// PageListUnsubscribeRecipients.swift
//
...
@objc public class PageListUnsubscribeRecipients: NSObject, Codable, JSONEncodable {

    public var content: [ListUnsubscribeRecipientProjection]?
    ...
    public init(content: [ListUnsubscribeRecipientProjection]? = nil, pageable: PageableObject? = nil, totalPages: Int, totalElements: Int64, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {

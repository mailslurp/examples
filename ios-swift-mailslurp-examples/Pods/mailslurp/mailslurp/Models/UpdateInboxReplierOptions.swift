//
// UpdateInboxReplierOptions.swift
//
...
@objc public class UpdateInboxReplierOptions: NSObject, Codable, JSONEncodable {
    ...
    public init(inboxId: UUID, name: String? = nil, field: Field, match: String, replyTo: String? = nil, subject: String? = nil, from: String? = nil, charset: String? = nil, isHTML: Bool? = nil, ignoreReplyTo: Bool? = nil, body: String? = nil, templateId: UUID? = nil, templateVariables: [String: AnyCodable]? = nil) {

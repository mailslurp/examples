...
@objc public class PageUnknownMissedEmailProjection: NSObject, Codable, JSONEncodable {
    ...
    public init(content: [UnknownMissedEmailProjection]? = nil, pageable: PageableObject? = nil, totalPages: Int, totalElements: Int64, last: Bool? = nil, numberOfElements: Int? = nil, first: Bool? = nil, size: Int? = nil, number: Int? = nil, sort: SortObject? = nil, empty: Bool? = nil) {
